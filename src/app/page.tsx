  ...
  return (
    <div className="min-h-screen">
      ...
      <footer className="py-14 px-6 md:px-8 section-divider text-center">
        <p className="text-slate-500 text-sm">© 2026 GrowthLens. Built by <a href="https://larry-dev.vercel.app" className="text-slate-400 hover:text-white transition-colors">Orión</a> on behalf of <a href="https://happyoperators.com" className="text-slate-400 hover:text-white transition-colors">Happy Operators Inc</a></p>
      </footer>
    </div>
  );
}
